              ...
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form className="p-4 md:p-5">
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="product-category" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Product Category
                      </label>
                      <select
                        id="product-category"
                    ...
                    <div>
                      <label htmlFor="product-subcategory" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Product Subcategory
                      </label>
                      <select
                    ...
                    <div>
                      <label htmlFor="product-brand" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Brand
                      </label>
                      <select
                        id="product-brand"
